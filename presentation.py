...
MAJOR, MINOR, PATCH, BETA = 3, 1, 1, 'b'
...
# this code is super fragile: it relies on pdf and javascript structure and
# naming conventions generated by the tex animate package:
